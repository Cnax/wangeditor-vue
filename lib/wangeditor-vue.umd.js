(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["wangeditor-vue"] = factory();
	else
		root["wangeditor-vue"] = factory();
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "install", function() { return /* reexport */ Editor_install; });
__webpack_require__.d(__webpack_exports__, "wangeditor", function() { return /* reexport */ Editor_src; });
      ...
      handler: function handler(val) {
        ...
        if (val) {
          this.$nextTick().then(function () {
            _this.editor && _this.editor.disable();
          });
        }
      }
    }
  ...
  methods: {
    loadEditor: function loadEditor() {
      ...
      Object.keys(this.config).forEach(function (k) {
        editor.config[k] = _this2.config[k];
      });

      editor.config.onchange = function (html) {
        var newHtml = _this2.openXss ? lib_default()(html) : html;
        _this2.content = newHtml;

        _this2.$emit('onChange', newHtml);
      };
...
var Editor_install = function install(Vue) {
  if (install.installed) return;
  install.installed = true;
  Vue.component(Editor_src.name, Editor_src);
};

if (typeof window !== 'undefined' && window.Vue) {
  Editor_install(window.Vue);
}

/* harmony default export */ var Editor = (Editor_src);
